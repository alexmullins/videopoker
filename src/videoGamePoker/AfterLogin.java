...
public class AfterLogin extends JFrame implements WindowStateListener{
	...
	public AfterLogin() {
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(topBanner, GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		txtPlayerName.setBorder(new EmptyBorder(0, 0, 0, 0));
		...
		txtPlayerCredits.setFont(new Font("Tahoma", Font.BOLD, 12));
		txtPlayerCredits.setBorder(new EmptyBorder(0, 0, 0, 0));
		txtPlayerCredits.setOpaque(false);
		txtPlayerCredits.setEditable(false);
		txtPlayerCredits.setText("10000 Credits");
		...
		gl_UserInfo.setHorizontalGroup(
			gl_UserInfo.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_UserInfo.createSequentialGroup()
					...
					.addComponent(txtPlayerName, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(txtPlayerCredits, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
			...
			gl_UserInfo.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_UserInfo.createSequentialGroup()
					...
					.addGroup(gl_UserInfo.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(txtPlayerCredits, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnLogout)))
		);
		...
		btnNewButton.setIcon(new ImageIcon(AfterLogin.class.getResource("/l.png")));
		...
		gl_topBanner.setHorizontalGroup(
			gl_topBanner.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_topBanner.createSequentialGroup()
					.addGap(327)
					.addComponent(btnNewButton, GroupLayout.DEFAULT_SIZE, 317, Short.MAX_VALUE)
					.addGap(320))
		);
		gl_topBanner.setVerticalGroup(
			gl_topBanner.createParallelGroup(Alignment.LEADING)
				.addComponent(btnNewButton, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
		);
